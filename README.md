...
* Data para entrega no prazo regular: `14/06/2024 23:59`.
...
* Use o comando: `git clone git@github.com:tryber/sd-036-project-algorithms.git`.
* Entre na pasta do repositório que você acabou de clonar:
  * `cd sd-036-project-algorithms`
...
* Crie uma branch à qual você vai submeter os `commits` do seu projeto
  ...
  * Exemplo: `git checkout -b joaozinho-sd-036-project-algorithms`
...
* Usando o exemplo anterior: `git push -u origin joaozinho-sd-036-project-algorithms`

  7. Crie um novo `Pull Request` _(PR)_

* Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-036-project-algorithms/pulls)
...
* Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-036-project-algorithms/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH36&template=betrybe/sd-0x-project-algorithms)
